...
import cv2
#reads in an individual FITS file from the "data" folder
im = fits.open('/Users/naomipark/Desktop/jpl_internship/naomipark_mirsi/data/237.fits.gz') #reads in fits file
red_data = im[0].data
